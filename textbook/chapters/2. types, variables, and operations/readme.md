...
Different data types are useful for different tasks, so it is important to understand how each one works. In this chapter, we will be learning about numeric and Boolean types as well as briefly discussing tuples. In following chapters we will learn about the other data types.
